...
With [Teams for Education](https://replit.com/teams-for-education) and [Private Invites](./inviting-managing-users), you can choose to generate a private invite link, which will protect the privacy of your students (including under 13-year olds). *Please note that students **must** be added using private invites for your team to be FERPA/COPPA compliant.*
